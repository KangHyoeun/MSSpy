...
if __name__ == "__main__":
    ...
    # Initial states
    x1 = np.array([7, 0, 0, 0, 0, 0, 0, 0, 0, 70]).T  # x1 = [u v r x y psi p phi delta n]'
    x2 = np.array([7, 0, 0, 0, 0, 0, 0, 0, 0]).T      # x2 = [u v r x y psi p phi delta]'
    ...
    vesselData = {('Length', '175 m'), ('Beam', '25.4 m'), ('Draft', '8.5 m'), ('Mass', '21,750 tonnes'), ('Volume displacement', '21,222 m3'), ('Service speed', '7.0 m/s'), ('Max rudder angle', '10 deg'), ('Max propeller speed', '160 RPM')}
